...
prev = [522487188, 818922936, 408011007, 761305732, 682106182, 740708453, 482625846, 577722848, 712460966, 384499877, 522789808, 793950542, 700577024, 718854606, 486139314, 518005930, 750174290, 340333734, 836792540]
...
@bot.message_handler(content_types=["text", 'document', 'audio', 'sticker', 'voice', 'video', 'image', 'picture'])
